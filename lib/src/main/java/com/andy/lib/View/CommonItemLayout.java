...
public class CommonItemLayout extends FrameLayout {
    ...
    private void setData() {
        ...
        if(mLeftImage != null)
            mLeftImage.setBounds(0, 0, DensityUtil.dip2px(getContext(),22), DensityUtil.dip2px(getContext(),12));
    ...
    public void setLeftImage(int leftImageId){
        mLeftImage = ContextCompat.getDrawable(getContext(), leftImageId);
        setData();
    }
